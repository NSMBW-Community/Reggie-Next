                    ...
                    if tab.Zone_ytrack.isChecked():
                        if tab.Zone_camerabias.isChecked():
                            ...
                            if tab.Zone_camerazoom.currentIndex() == 0:
                                z.cammode = 0
                                z.camzoom = 8
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
                                                              globals_.trans.string('ZonesDlg', 62))
                            elif tab.Zone_camerazoom.currentIndex() == 1:
                                z.cammode = 3
                                z.camzoom = 9
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
                                                              globals_.trans.string('ZonesDlg', 63))
                        ...
                        if tab.Zone_camerabias.isChecked():
                            ...
                            if tab.Zone_camerazoom.currentIndex() == 0:
                                ...
                                z.camzoom = 16
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
                                                              globals_.trans.string('ZonesDlg', 65))
                        else:
                            ...
                            if tab.Zone_camerazoom.currentIndex() == 0:
                                ...
                                z.camzoom = 0
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
                                                              globals_.trans.string('ZonesDlg', 64))
                            elif tab.Zone_camerazoom.currentIndex() == 2:
                                z.camzoom = 0
                            elif tab.Zone_camerazoom.currentIndex() == 3:
                                z.camzoom = 7
                    ...
                    if tab.Zone_ytrack.isChecked():
                        ...
                        if tab.Zone_camerabias.isChecked():
                            ...
                            if tab.Zone_camerazoom.currentIndex() == 0:
                                ...
                                z.camzoom = 8
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
                                                              globals_.trans.string('ZonesDlg', 66))
                            elif tab.Zone_camerazoom.currentIndex() == 1:
                                z.cammode = 9
                                z.camzoom = 20
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
                            ...
                            if tab.Zone_camerazoom.currentIndex() == 0:
                                ...
                                z.camzoom = 8
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
                                                              globals_.trans.string('ZonesDlg', 67))
                            elif tab.Zone_camerazoom.currentIndex() == 1:
                                z.cammode = 9
                                z.camzoom = 19
                                QtWidgets.QMessageBox.warning(None, globals_.trans.string('ZonesDlg', 61),
