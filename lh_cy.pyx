...
cdef unsigned int GetUncompressedSize(bytearray inData):
...
def IsLHCompressed(bytes inData):
...
cpdef bytes UncompressLH(bytearray inData):
    ...
    cdef unsigned int r0 = 0x10
    cdef unsigned int r3 = 0x100
    cdef unsigned int r4 = 0
    cdef unsigned int r5 = 0
    cdef unsigned int r6 = 0
