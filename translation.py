    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            ...
            'ZonesDlg': {
                ...
                47: 'Bounds',
                48: 'Upper Bounds:',
                49: '[b]Upper Bounds:[/b][br]Controls how close Mario needs to be to the top edge of the screen to move the camera upwards. Units are 1/16 of a tile. Positive values: Easier to scroll upwards. Negative values: Harder to scroll upwards.[br][br][b]Values -177 to -256:[/b] Prevent the screen from scrolling upwards at all[br][b]Values -81 to -176:[/b] Screen scrolls only when Mario is above the screen[br][b]Value -80:[/b] Top edge of the screen[br][b]Value 0:[/b] 5 tiles away from the top edge of the screen[br][b]Values 128 to 255:[/b] Cause instant death upon scrolling (Screen Height)[br][br][b]Good Values:[/b][br]Screen Height 7: -48 to -24[br]Screen Height 10.5: -48 to 0[br]Screen Height 14: -48 to 32[br]Screen Height 17: -48 to 56[br]Screen Height 20: -48 to 80[br]Screen Height 24: -48 to 112[br]Screen Height 28: -48 to 144',
                50: 'Lower Bounds:',
                51: '[b]Lower Bounds:[/b][br]Controls how close Mario needs to be to the bottom edge of the screen to move the camera downwards. Units are 1/16 of a tile. Positive values: Harder to scroll downwards. Negative values: Easier to scroll downwards.[br][br][b]Values 177 to 256:[/b] Prevent the screen from scrolling downwards at all[br][b]Values 73 to 176:[/b] Screen scrolls only when Mario is below the screen[br][b]Value 72:[/b] Bottom edge of the screen[br][b]Value 0:[/b] 4.5 tiles away from the bottom edge of the screen[br][b]Values -128 to -256:[/b] Cause instant death upon scrolling (Screen Height)[br][br][b]Good Values:[/b][br]Screen Height 7: 40 to 16[br]Screen Height 10.5: 40 to -8[br]Screen Height 14: 40 to -40[br]Screen Height 17: 40 to -64[br]Screen Height 20: 40 to -88[br]Screen Height 24: 40 to -120[br]Screen Height 28: 40 to -152',
                52: 'Audio',
                53: 'Background Music:',
