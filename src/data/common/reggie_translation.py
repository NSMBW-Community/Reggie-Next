    ...
    def InitAsEnglish(self) -> None:
        ...
        self.strings: dict[str, dict[int, str | None | tuple[str | None, ...]]] = {
            ...
            'AreaDlg': {
                ...
                38: 'Useless Option 1',
                39: '[b]Useless Option 1:[/b] This serves no purpose in-game, and is usually turned off in most retail levels.',
                40: 'Useless Option 2',
                41: '[b]Useless Option 2:[/b] This serves no purpose in-game, but is usually turned on in most retail levels.',
                42: 'Useless Option 3',
                43: '[b]Useless Option 3:[/b] This serves no purpose in-game.',
                44: 'Useless Option 4',
                45: '[b]Useless Option 4:[/b] This serves no purpose in-game.',
                46: 'Loaded Sprites',
                47: 'Add Sprite',
            ...
            'BGDlg': {
                ...
                13: 'Zoom:',
                14: '[b]Zoom:[/b][br]Sets the zoom level of the background model',
                15: (
                    '100%',
                    '125%',
                    '150%',
                ...
                21: (
                    'Invalid',
                    'Align Slot 3 to Bottom of Zone',
                    'Align Slot 1 to Top of Zone',
                    'Crashes',
                    'Crashes',
                    'Align to Screen, Single Background',
                    'Default',
                    'Align to Screen, Multiple Backgrounds',
                ),
                22: 'Slot [i]:',
                23: 'This mode will not render any backgrounds.',
                24: 'This mode crashes the game, so consider changing your background configuation.',
            },
            'ChangeGamePath': {
            ...
            'EntranceDataEditor': {
                ...
                14: 'Reverse Path',
                15: '[b]Reverse Path:[/b][br]This box tells the connected pipe whether or not it should follow its path in reverse (backwards).',
                16: 'Path ID:',
                ...
                25: 'Exit Direction:',
                26: '[b]Exit Direction:[/b][br]Set the direction the player will exit out of a connected pipe.',
                27: (
                    'Up',
                    'Down',
                    'Left',
            ...
            'Palette': {
                ...
                25: 'Add',
                26: 'Current',
                27: 'Available stamps:[br](Select one or more objects/sprites to create one)',
                28: 'Add',
                29: 'Remove',
                30: 'Tools',
                31: 'Import Set...',
            ...
            'PrefsDlg': {
                ...
                46: '[b]Use Rounded Rectangles:[/b][br]This makes the corners of sprites, entrances, path nodes, and comments appear rounded instead of sharp.',
                47: 'Dark Mode',
                ...
                49: 'Display full file path of opened level',
                ...
                53: 'Change Item Cursors:',
                54: '[b]Change Item Cursors:[/b][br]This determines the appearance of the cursor when moving or resizing level items.',
                55: (
                    'Never',
                    'Only while selected',
                    'Always',
            ...
            'SpriteDataEditor': {
                ...
                7: 'Object Files',
                8: '[b]This sprite loads:[/b][br]* [list]',
            ...
            'Sprites': {
                ...
                1: None,  # REMOVED: '[name] (at [x], [y]',
                2: None,  # REMOVED: ', triggered by event [event]',
                3: None,  # REMOVED: ', triggered by events [event1]+[event2]+[event3]+[event4]',
                4: None,  # REMOVED: ', triggered by event [event1], [event2], [event3], or [event4]',
                5: None,  # REMOVED: ', activates event [event]',
                6: None,  # REMOVED: ', activates events [event1] - [event2]',
                7: None,  # REMOVED: ', activates event [event1], [event2], [event3], or [event4]',
                8: None,  # REMOVED: ', Star Coin [num]',
                9: None,  # REMOVED: ', Star Coin 1',
                10: None,  # REMOVED: ', Coin/Set ID [id]',
                11: None,  # REMOVED: ', Movement/Coin ID [id]',
                12: None,  # REMOVED: ', Movement ID [id]',
                13: None,  # REMOVED: ', Rotation ID [id]',
                14: None,  # REMOVED: ', Location ID [id]',
                15: None,  # REMOVED: ')',
                16: 'Search Results',
                17: 'No sprites found',
                18: '[id]: [name]',
